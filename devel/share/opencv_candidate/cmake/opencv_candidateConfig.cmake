...
if("TRUE" STREQUAL "TRUE")
  set(opencv_candidate_SOURCE_PREFIX /home/lhn/ork_ws/src/opencv_candidate)
  set(opencv_candidate_DEVEL_PREFIX /home/lhn/ork_ws/devel)
  ...
  set(opencv_candidate_INSTALL_PREFIX /home/lhn/ork_ws/install)
...
if(NOT "/home/lhn/ork_ws/src/opencv_candidate/include;/opt/ros/kinetic/include/opencv-3.3.1-dev;/opt/ros/kinetic/include/opencv-3.3.1-dev/opencv " STREQUAL " ")
  set(opencv_candidate_INCLUDE_DIRS "")
  set(_include_dirs "/home/lhn/ork_ws/src/opencv_candidate/include;/opt/ros/kinetic/include/opencv-3.3.1-dev;/opt/ros/kinetic/include/opencv-3.3.1-dev/opencv")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT "https://github.com/wg-perception/opencv_candidate " STREQUAL " ")
    set(_report "Check the website 'https://github.com/wg-perception/opencv_candidate' for information and consider reporting the problem.")
  else()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${opencv_candidate_dep}_FOUND)
      find_package(${opencv_candidate_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${opencv_candidate_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
