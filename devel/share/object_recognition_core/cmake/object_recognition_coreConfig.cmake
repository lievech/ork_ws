...
if("TRUE" STREQUAL "TRUE")
  set(object_recognition_core_SOURCE_PREFIX /home/lhn/ork_ws/src/ork_core)
  set(object_recognition_core_DEVEL_PREFIX /home/lhn/ork_ws/devel)
  ...
  set(object_recognition_core_INSTALL_PREFIX /home/lhn/ork_ws/install)
...
if(NOT "/home/lhn/ork_ws/src/ork_core/include " STREQUAL " ")
  set(object_recognition_core_INCLUDE_DIRS "")
  set(_include_dirs "/home/lhn/ork_ws/src/ork_core/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT "http://wg-perception.github.io/object_recognition_core/ " STREQUAL " ")
    set(_report "Check the website 'http://wg-perception.github.io/object_recognition_core/' for information and consider reporting the problem.")
  else()
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'object_recognition_core' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'object_recognition_core' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lhn/ork_ws/src/ork_core/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${object_recognition_core_dep}_FOUND)
      find_package(${object_recognition_core_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${object_recognition_core_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(object_recognition_core_INCLUDE_DIRS ${${object_recognition_core_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(object_recognition_core_LIBRARIES ${object_recognition_core_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${object_recognition_core_dep}_LIBRARIES})
  _list_append_deduplicate(object_recognition_core_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(object_recognition_core_LIBRARIES ${object_recognition_core_LIBRARIES})
