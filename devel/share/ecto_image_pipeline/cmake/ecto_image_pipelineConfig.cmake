...
if(ecto_image_pipeline_CONFIG_INCLUDED)
  return()
endif()
set(ecto_image_pipeline_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(ecto_image_pipeline_SOURCE_PREFIX /home/lhn/ork_ws/src/ecto_image_pipeline)
  set(ecto_image_pipeline_DEVEL_PREFIX /home/lhn/ork_ws/devel)
  set(ecto_image_pipeline_INSTALL_PREFIX "")
  set(ecto_image_pipeline_PREFIX ${ecto_image_pipeline_DEVEL_PREFIX})
else()
  set(ecto_image_pipeline_SOURCE_PREFIX "")
  set(ecto_image_pipeline_DEVEL_PREFIX "")
  set(ecto_image_pipeline_INSTALL_PREFIX /home/lhn/ork_ws/install)
  set(ecto_image_pipeline_PREFIX ${ecto_image_pipeline_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'ecto_image_pipeline' is deprecated")
...
set(ecto_image_pipeline_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/lhn/ork_ws/src/ecto_image_pipeline/include;/usr/include;/usr/include/eigen3;/opt/ros/kinetic/include/opencv-3.3.1-dev;/opt/ros/kinetic/include/opencv-3.3.1-dev/opencv;/usr/include/pcl-1.7 " STREQUAL " ")
  set(ecto_image_pipeline_INCLUDE_DIRS "")
  set(_include_dirs "/home/lhn/ork_ws/src/ecto_image_pipeline/include;/usr/include;/usr/include/eigen3;/opt/ros/kinetic/include/opencv-3.3.1-dev;/opt/ros/kinetic/include/opencv-3.3.1-dev/opencv;/usr/include/pcl-1.7")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT "http://plasmodic.github.io/ecto_image_pipeline/ " STREQUAL " ")
    set(_report "Check the website 'http://plasmodic.github.io/ecto_image_pipeline/' for information and consider reporting the problem.")
  else()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(ecto_image_pipeline_LIBRARY_DIRS ${lib_path})
      list(APPEND ecto_image_pipeline_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'ecto_image_pipeline'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND ecto_image_pipeline_LIBRARIES ${lib})
    endif()
  endif()
...
set(ecto_image_pipeline_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${ecto_image_pipeline_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()

set(depends "opencv_candidate")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 ecto_image_pipeline_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${ecto_image_pipeline_dep}_FOUND)
      find_package(${ecto_image_pipeline_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${ecto_image_pipeline_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(ecto_image_pipeline_INCLUDE_DIRS ${${ecto_image_pipeline_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(ecto_image_pipeline_LIBRARIES ${ecto_image_pipeline_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${ecto_image_pipeline_dep}_LIBRARIES})
  _list_append_deduplicate(ecto_image_pipeline_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(ecto_image_pipeline_LIBRARIES ${ecto_image_pipeline_LIBRARIES})

  _list_append_unique(ecto_image_pipeline_LIBRARY_DIRS ${${ecto_image_pipeline_dep}_LIBRARY_DIRS})
  list(APPEND ecto_image_pipeline_EXPORTED_TARGETS ${${ecto_image_pipeline_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${ecto_image_pipeline_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
